...
date: "2022-07-07"
categories: [r, nfl, unsupervised learning]
format:
  html:
    highlight: true
    code-fold: show
...
Doing a PCA in R is quite easy, but visualising the results can be a challenge. I am going to demonstrate it with NFL data just to add some complexity to it.

I wont write much on this post due to time constraints, however, most of the code is commented well enough.
...
#| echo: false
#| warning: false
wr_stats <- read_csv('wr_stats_2021.csv')
```
